...
const mcp = new Server(
  { name: 'discord', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      '',
      'MANDATORY — a <channel source="discord"> tag means a person is waiting in Discord. Work is not delivered until it has gone out through the reply tool with the chat_id from that tag; transcript output does not count, however complete it looks.',
