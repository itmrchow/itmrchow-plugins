...
const mcp = new Server(
  { name: 'discord', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      '',
      'MANDATORY — a <channel> tag means a person is waiting in Discord. Work is not delivered until it has gone out through the reply tool with that chat_id; transcript output does not count, however complete it looks.',
